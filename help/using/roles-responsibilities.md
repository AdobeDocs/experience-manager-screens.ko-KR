...
성공적인 디지털 사이니지 배포를 지원하기 위해 일반적으로 프로젝트를 3단계로 세그먼트화합니다.  이러한 단계를 일반적으로 다음과 같이 합니다. **일**. 이것은 문자 그대로의 날이 아니라 프로젝트의 각 주요 단계에 대한 지정입니다.
...
>
>다음에 대한 추가 비디오 팔로우 **[프로젝트 관리 및 배포](https://helpx.adobe.com/experience-manager/6-5/screens/using/project-management-and-deployment.html)** 프로젝트 사전 프로덕션, 프로젝트 시작 및 프로젝트 진행에 대해 알아봅니다.
...
>[!NOTE]
>
>이 차트는 정확하게 따르기 위한 것이 아니라 AEM Screens 프로젝트의 일반적인 작업 및 고려 사항의 예를 제공하기 위한 것입니다.

### RACI 정의 {#raci-definitions}

* **책임**: 작업을 완료하는 데 사용됩니다.

* **책임 있음**: 위임은 작업을 수행하며 작업을 완료하기 전에 검토할 마지막 당사자입니다.
...
| **단계** | **A/V 통합자** | **AEM 구현자** | **비즈니스 전략** | **콘텐츠 관리** |
|---|---|---|---|---|
...
* **기술자**: AV 통합업체에 의해 계약되거나 동일한 회사에 속합니다.
