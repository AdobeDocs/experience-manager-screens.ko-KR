...
| *첫째 날:프로젝트 구현(응용 프로그램 디자인)* |
| 역할 및 책임에 대한 합의 | RA | RA | RA | RA |
| 프로젝트 계획 및 일정 정렬 | RA | RA | C | C |
| 현재 서버 환경 평가 | I | RA | I | I |
| UX 디자인 요구 사항 | I | AR | C | AR |
| 기술 요구 사항 검증 | I | RA | RA | C |
| 아키텍처 설계 | I | AR | I | I |
| UI 디자인을 사용하여 데이터 구조 유효성 검사 | I | AR | C | C |
| 애플리케이션 개발 | RA | RA | RA | RA |
| AEM Screens 프로젝트 설정 | I | AR | C | I |
| Analytics 구현 | I | AR | C | - |
| 테스트 및 배포 | AR | C | AR | I |
| 서버 구성 | I | AR | I | I |
| 컨텐츠 업데이트 계획 | I | AR | C | C |
| 파일럿-생산 전환 계획 | AR | AR | I | I |
| 기술 자료 전송 | AR | AR | I | I |
| *첫째 날:프로젝트 구현(소매 준비)* |
| 하드웨어 주문 및 스토리지 | AR | I | I | I |
| 소매 온보딩 일정 | I | I | C | AR |
| 스테이징 사용자 수락 테스트 | I | C | AR |  |
| 하드웨어 벌크 구성 | AR | I | C | I |
| 출시 후 지원 계약 | AR | C | AR | C |
| *첫째 날:첫째 날:프로젝트 구현(하드웨어)* |
| 역할 및 책임 계약 | RA | RA | RA | RA |
