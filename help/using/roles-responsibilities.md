...
성공적인 디지털 서명 배포를 지원하기 위해 프로젝트를 3단계로 나누는 것이 관례입니다.  이러한 단계는 일반적으로 날이라고 **합니다**. 이것은 문자 그대로 진행되는 것이 아니라 프로젝트의 각 주요 단계에 대한 지정입니다.

1. 첫 번째 단계를 영이라고 *합니다*. 이 단계에는 프로젝트 범위를 완전히 정의하는 데 필요한 모든 사전 판매 및 검색 노력이 포함됩니다.

1. 두 번째 단계인 *첫 번째*&#x200B;날은 배포 작업에 포함된 모든 활동을 의미합니다.

1. 세 번째 단계 및 마지막 *둘째 날* 총 솔루션의 일부로 진행 중인 모든 작업 및 지원 요소를 의미합니다.
...
>[!NOTE]
>
> 이 차트는 정확하게 따라가지 않고 AEM Screens 프로젝트에서 일반적인 작업 및 고려 사항의 예를 제공하기 위해 마련되었습니다.
...
* **상담**:입력을 위해 작업 또는 결과물을 검토합니다.

* **알림**:작업에 대한 진행 상황을 지속적으로 알려왔지만 결과물의 세부 사항에는 포함되지 않습니다.

다음은 역할 정의를 사용하는 샘플 RACI 차트이며 AEM Screens 프로젝트에서 일반적인 작업 및 고려 사항의 예를 제공합니다.

다음 표에는 영일이 요약되어 **있습니다.사전 판매 고려 사항**:

| **위상** | **A/V 통합자** | **AEM 구현자** | **비즈니스 전략** | **컨텐츠 관리** |
|---|---|---|---|---|
| 팀 구성 및 공급업체 선택 | I | I | RA | RA |
| 역할 및 책임 계약 | RA | RA | RA | RA |
...
다음 표에는 2일이 요약되어 **있습니다.게시물 시작 지원 RACI 차트**:
