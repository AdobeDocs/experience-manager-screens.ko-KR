...
성공적인 디지털 서명 배포를 지원하려면 프로젝트를 3단계로 분류하는 것이 좋습니다.  이러한 단계는 일반적으로 **일**&#x200B;이라고 합니다. 이는 문자 그대로 진행되는 것이 아니라 프로젝트의 각 주요 단계에 대한 지정입니다.

1. 첫 번째 단계를 *일 제로*&#x200B;라고 합니다. 이 단계에는 프로젝트 범위를 완전히 정의하는 데 필요한 모든 사전 판매 및 검색 노력이 포함됩니다.
1. 두 번째 단계인 *일*&#x200B;은 배포 작업에 포함된 모든 활동을 나타냅니다.
1. 세 번째 단계 및 마지막 단계 *일 두 번째 단계*&#x200B;는 총 솔루션의 일부로서 진행 중인 모든 작업 및 지원 요소를 나타냅니다.

>[!NOTE]
>
>이 가이드는 주로 *1일차* 및 *2일차*&#x200B;에 중점을 두지만, 성공적인 디지털 사이니지 프로젝트를 수행하기 위해서는 세 가지 단계에 모두 관심을 기울여야 합니다.
>
>**[프로젝트 관리 및 배포](https://helpx.adobe.com/experience-manager/6-5/screens/using/project-management-and-deployment.html)**&#x200B;에 대한 추가 비디오에 따라 프로젝트 사전 제작, 프로젝트 시작 및 프로젝트 진행 상황에 대해 알아보십시오.
...
| **위상** | **A/V 통합자** | **AEM 시행자** | **비즈니스 전략** | **컨텐츠 관리** |
|---|---|---|---|---|
...
다음 표에 **일 1이 요약되어 있습니다.프로젝트 구현(응용 프로그램 디자인)**:
...
다음 표에 **일 1이 요약되어 있습니다.프로젝트 구현(소매 준비)**:
...
다음 표에 **일 1이 요약되어 있습니다.첫째 날:프로젝트 구현(하드웨어)**:
...
다음 표에는 **2일이 요약되어 있습니다.게시물 실행 지원 RACI 차트**:
