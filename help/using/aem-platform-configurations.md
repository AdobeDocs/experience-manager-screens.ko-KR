...
AMS 인스턴스에서 AEM의 암호 정책을 비활성화해야 합니다. 또한 Screens 장치 서비스 *com.adobe.cq.screens.device.impl.DeviceService를 사용하여 웹 콘솔에서 교대로 구성할 수 있습니다*
[AEM Screens에서 작성자 및 게시 구성](https://experienceleague.adobe.com/en/docs/experience-manager-screens/user-guide/administering/author-publish/author-and-publish)에서 **암호 제한** 섹션을 참조하십시오.
