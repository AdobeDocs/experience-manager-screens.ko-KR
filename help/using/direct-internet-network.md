...
*충분한* 것은 연결된 AEM 화면 수와 네트워크 내의 다른 소비자(예: 스마트폰, 타블렛, 계산원, 컴퓨터 또는 게스트 WIFI 네트워크)의 사용에 따라 달라집니다.
...
>[!NOTE]
>WIFI 반복이 필요한 경우 Google Nest Mesh WIFI 또는 이와 유사한 Mesh WIFI 액세스 포인트가 권장됩니다. 다른 WiFi 반복 기술은 전체 네트워크의 대역폭을 크게 손실합니다.
