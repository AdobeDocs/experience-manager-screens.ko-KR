...
>[!NOTE]
>
>기본적으로 초기 구조에는 **일정**, **위치**, **응용 프로그램**, **채널** 및 **장치** 마스터 페이지가 포함되지만 필요한 경우 수동으로 조정할 수 있습니다. 사용 가능한 옵션이 프로젝트와 관련이 없는 경우 해당 옵션을 제거할 수 있습니다.
...
프로젝트에 사용할 수 있는 **일정**, **위치**, **응용 프로그램**, **채널** 및 **장치** 마스터 페이지 아래에서 사용자 지정 폴더를 만들 수도 있습니다.
...
다음 단계는 **TestScreens**&#x200B;의 **Applications** 마스터 페이지에 응용 프로그램 폴더를 만드는 방법을 보여 줍니다.
