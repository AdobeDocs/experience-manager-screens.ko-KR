...
1. 다음 항목 선택 **시퀀스 채널** 템플릿 위치: **만들기** 마법사 및 선택 **다음**.

   ![demochannel](assets/create-channel2.png)

1. 제목 입력 **ScreensChannel** 및 선택 **만들기**.
...
1. 선택 **편집** 채널 속성을 편집할 수 있도록 작업 표시줄의 왼쪽 상단 모서리에서 게시할 채널에 에셋/구성 요소를 추가할 수 있는 편집기가 열립니다.
...
1. 편집할 채널을 선택합니다.
1. 선택 **속성** 채널 속성을 보거나 편집할 수 있도록 작업 표시줄에서 을 클릭합니다. 다음 탭에서는 옵션을 변경할 수 있습니다.
...
1. 다음으로 채널 탐색 **테스트 프로젝트** > **채널** > **테스트 채널**.
   ...
   선택 **대시보드** 플레이어의 상태를 볼 수 있도록 작업 표시줄에서 을 선택합니다. 다음 **채널 정보** 패널은 채널이 온라인인지 오프라인인지에 대한 정보를 제공합니다.

   ![screen_shot_2019-08-01at31458pm](assets/screen_shot_2019-08-01at31458pm.png)

1. 선택 **속성** 작업 표시줄에서 **채널** 아래 표시된 탭:

   ![screen_shot_2019-08-01at31542pm](assets/screen_shot_2019-08-01at31542pm.png)

1. 다음 확인: **개발자** **모드(온라인 채널 강제 설정)** 온라인 상태로 만듭니다.

   선택 **저장 및 닫기** 옵션을 저장합니다.
...
>[!NOTE]
>채널을 다시 오프라인으로 구성하려면 다음에서 개발자 모드 옵션을 선택 취소합니다. **속성** 탭(3단계에서 설명). 그런 다음 **채널 정보** 패널 선택 **오프라인 컨텐츠 업데이트**&#x200B;을 참조하십시오.
