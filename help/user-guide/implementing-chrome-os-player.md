...
1. Chrome OS 장치를 도메인에 등록하고 장치가 Chrome 관리 콘솔과 동기화되려면 15분이 걸립니다. Chrome 장치 등록에 대해 자세히 알려면 다음을 선택합니다. [여기](https://support.google.com/chrome/a/answer/1360534?hl=en).
...
1. 아래로 스크롤하여 **키오스크 설정** 및 선택 **키오스크 애플리케이션 관리**.
...
1. 선택 **장치 관리** > **Chrome 관리** > **앱 관리**. AEM Screens 플레이어가 목록에 표시됩니다.
1. 애플리케이션 선택 **AEM Screens 플레이어**.
1. 선택 **키오스크 설정** 조직 선택(*테스트 환경을 사용하는 경우*).
1. 선택 **구성 파일 업로드** 및 구성 정책 업로드(*JSon 파일*).
1. **저장**&#x200B;을 선택합니다. 정책을 동기화할 수 있도록 장치를 다시 부팅합니다.
