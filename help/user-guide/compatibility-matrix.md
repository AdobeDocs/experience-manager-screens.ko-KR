---
title: AEM Screens 플레이어용 호환성 매트릭스
seo-title: AEM Screens 플레이어용 호환성 매트릭스
description: 이 페이지에는 해당 AEM Screens 버전과 함께 AEM Screens 플레이어가 나열됩니다.
seo-description: 이 페이지에는 해당 AEM Screens 버전과 함께 AEM Screens 플레이어가 나열됩니다.
...
# AEM Screens 플레이어용 호환성 매트릭스{#compatibility-matrix-for-aem-screens-player}

>[!NOTE]
>
>다음 정보는 2018년 5월 14일부터 업데이트됩니다.

다음 섹션에서는 각 AEM Screens 버전과 함께 Adobe Experience Manager(AEM) Screens 플레이어를 나열합니다.
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p><strong>3.2.72</strong> - Apple 스토어에서 이용 가능</p> <p> </p> </td> 
  </tr>
  <tr>
...
|---|---|
| **AEM 6.3+SP1+Screens FP1(1.0.64_B002)** | **3.2.68 -** (Macromedia 사이트에서 제공) 및 Google Play 스토어 |
...
<table>
 <tbody>
  ...
  <tr>
   <td><strong>AEM 6.3+SP1+Screens FP1(1.0.64_B002)</strong></td> 
   <td><p><strong>3.2.72 - </strong>Apple 스토어에서 이용 가능</p> <p><strong>3.3.0</strong> - 작동하지 않음</p> <p> </p> </td> 
   <td><strong>1.0.12</strong> - (Macromedia에서 사용 가능)</td> 
   <td><p><strong>1.0.30 - Chrome</strong> Store에서 사용 가능.</p> <p>Feature Pack1에서 지원되지 않음</p> </td> 
   <td><strong>3.2.68 -</strong> (Macromedia 사이트에서 제공) 및 Google Play 스토어</td> 
  </tr>
  <tr>
   <td><strong><strong>AEM 6.3+SP1+Screens FP2(1.0.298)</strong></strong></td> 
