...
AMS 커넥터가 작동할 AEM 6.5 기능 팩 8 의 최소 버전을 설치합니다. AEM Screens 기능 팩의 최소 버전을 가져올 수 있도록 [가용성](https://experienceleague.adobe.com/en/docs/experience-manager-screens/user-guide/release-notes/release-notes-fp-202105#availability)을 참조하세요.
