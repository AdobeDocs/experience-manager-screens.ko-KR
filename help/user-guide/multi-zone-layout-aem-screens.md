...
1. 클릭 **1x2 분할 화면 채널** 다음에서 **만들기** 마법사.
...
1. **채널에 콘텐츠 추가**
   ...
   1. 다음을 클릭합니다. **다중 영역** 채널 및 클릭 **편집** 작업 표시줄에서
...
1. **채널 폴더 만들기**
   ...
   1. 클릭 **채널 폴더** 다음에서 **만들기** 마법사 및 클릭 **다음**.
...
1. **채널 폴더에 채널 2개 추가**
   ...
   1. 클릭 **시퀀스 채널** 다음에서 **만들기** 이라는 제목이 있는 채널을 만드는 마법사 **`Zone1`**.
   1. 클릭 **`Zone1`** 및 클릭 **편집** 작업 표시줄에서
...
1. **주 채널(MultiZone)에 임베드된 시퀀스(구성 요소) 추가**
   ...
   1. 다음으로 채널 경로 클릭 **영역** > **채널** > **EmbeddedChannel** > **`Zone1`**&#x200B;을 참조하십시오.
...
1. **위치 생성**
   ...
   1. 다음을 클릭합니다. **위치** 폴더 및 클릭 **만들기** 작업 표시줄에서
   1. 클릭 **위치** 다음에서 **만들기** 마법사 및 클릭 **다음**.
   1. 다음을 입력합니다. **제목** 다음으로: **산호세** 및 클릭 **만들기**.

1. **디스플레이 만들기**

   1. 다음으로 이동 **영역** > **위치** 폴더를 삭제합니다.
   1. 다음을 클릭합니다. **산호세** 위치 및 클릭 **만들기** 작업 표시줄에서
...
1. **디스플레이에 채널 할당**
   ...
   1. 다음을 클릭합니다. **로비** 표시 및 클릭 **채널 할당** 작업 표시줄에서
...
1. **장치 등록**
   ...
   1. 클릭 **장치 등록** 목록에서 보류 중인 장치를 클릭합니다.

      >[!NOTE]
      > 장치의 제목은 장치 토큰( )과 일치해야 합니다.**토큰** 필드)에 표시됨 **장치 등록** 탭.

   1. 제목이 장치 토큰과 일치하는 경우 장치를 클릭하고 을 클릭합니다. **장치 등록** 작업 표시줄에서
   ...
   1. 클릭 **디스플레이 할당** 을 클릭하고 장치 구성의 경로를 클릭합니다.
