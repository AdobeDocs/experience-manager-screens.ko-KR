...
1. 다음으로 이동 **채널** 폴더 및 선택 **만들기** 작업 표시줄에서

1. 선택 **1x2 분할 화면 채널** 다음에서 **만들기** 마법사.

1. 선택 **다음** 을(를) 입력한 후 **제목** 다음으로: **다중 영역**.

1. 선택 **만들기** 을 클릭하여 채널 만들기를 완료합니다.
...
1. **채널에 콘텐츠 추가**
   ...
   1. 다음 항목 선택 **다중 영역** 채널 및 선택 **편집** 작업 표시줄에서
...
1. **채널 폴더 만들기**
   ...
   1. 다음으로 이동 **영역** > **다중 영역** > **채널** 및 선택 **만들기** 작업 표시줄에서
   1. 선택 **채널 폴더** 다음에서 **만들기** 마법사 및 선택 **다음**.
   1. 제목을 다음으로 입력 **EmbeddedChannel** 및 선택 **만들기**.

   ![screen_shot_2018-12-19at125428pm](assets/screen_shot_2018-12-19at125428pm.png)

1. **채널 폴더에 채널 2개 추가**

   1. 다음으로 이동 **영역** > **채널** > **EmbeddedChannel** 및 선택 **만들기** 작업 표시줄에서
   1. 선택 **시퀀스 채널** 다음에서 **만들기** 이라는 제목이 있는 채널을 만드는 마법사 **`Zone1`**.
   1. 선택 **`Zone1`** 및 선택 **편집** 작업 표시줄에서
...
1. **주 채널(MultiZone)에 임베드된 시퀀스(구성 요소) 추가**
   ...
   1. 다음 항목 선택 **구성** (렌치) 아이콘 을 사용하여 편집기에 포함된 시퀀스 중 하나를 표시할 수 있습니다.
