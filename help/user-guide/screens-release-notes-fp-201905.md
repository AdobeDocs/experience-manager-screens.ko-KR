...
AEM Screens은 다음 세부 정보와 함께 AEM 6.3.3.3 기능 팩 6 및 AEM 6.4.4.0 기능 팩 4를 릴리스했습니다.
...
이 섹션에서는 AEM SPA 편집기를 사용하여 REACT(또는 Angular)를 사용하여 대화형 단일 페이지 애플리케이션을 임베드하는 방법에 대해 설명합니다. AEM의 비즈니스 전문가가 편집기를 구성할 수 있습니다. 또한 대화형 애플리케이션을 오프라인 Adobe Analytics과 통합하는 방법도 설명합니다.

자세한 내용은 **[AEM SPA 편집기를 사용하여 REACT 응용 프로그램 포함 및 AEM Screens Analytics와 통합](embedding-react-app.md)**&#x200B;을 참조하십시오.

### 릴리스된 AEM Screens 플레이어

AEM 6.3.3.3 기능 팩 6 및 AEM 6.4.4.0 기능 팩 4용으로 다음 AEM Screens 플레이어가 릴리스되었습니다.
