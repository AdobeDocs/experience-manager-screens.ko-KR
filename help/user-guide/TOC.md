...
+ 개요 및 킥스타트 안내서 {#overview}
   ...
   + [Screens 우수 사례 안내서](https://experienceleague.adobe.com/ko/docs/experience-manager-screens/using/about-guide)
...
+ 구성 및 관리 {#administering}
   ...
   + 클라이언트별 고려 사항 {#installing-client}
      ...
      + [™ 플레이어](implementing-android-player.md)
...
+ 릴리스 정보 {#release-notes}
   + [기능 팩 20260318 릴리스 정보](release-notes-fp-20260318.md)
