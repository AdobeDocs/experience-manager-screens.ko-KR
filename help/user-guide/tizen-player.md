...
1. 리모콘의 메뉴를 누르고 System으로 이동한 다음 Play Via를 누릅니다.

   >[!NOTE]
   >화면이 URL 런처를 통해 재생되도록 설정되어 있는지 확인합니다.
...
1. 화면이 URL 런처를 통해 재생되도록 설정되어 있는지 확인하십시오.
1. 리모콘의 메뉴를 누르고 System으로 이동한 다음 Play Via를 누릅니다.
1. 메뉴 -> 네트워크 -> 서버 네트워크 설정으로 이동하고 Enter 키를 누릅니다.
1. [서버 주소]로 이동하여 MagicInfo URL 액세스를 입력하고 [완료]를 누릅니다.
