...
1. Adobe Experience Manager(AEM) 인스턴스로 이동하고 **스크린**&#x200B;을 클릭합니다. 또는 `https://localhost:4502/screens.html/content/screens](https://localhost:4502/screens.html/content/screens`에서 직접 탐색할 수도 있습니다.
...
1. **제목**&#x200B;을 **TestChannel**&#x200B;로 입력하고 **만들기**&#x200B;를 클릭합니다.
   ...
   이제 아래 그림과 같이 **TestChannel**&#x200B;이 채널 폴더에 추가됩니다.
...
1. **제목**&#x200B;을 **LobbyDisplay**&#x200B;으로 입력하고 **만들기**&#x200B;를 클릭합니다.
