...
1. 제목을 다음으로 입력 **데모 화면**&#x200B;을 클릭한 다음 을 클릭합니다 **저장**.
   ...
   >[!NOTE]
   >프로젝트를 만들면 AEM Screens 프로젝트 홈 페이지로 돌아갑니다. 이제 프로젝트를 클릭합니다. 프로젝트에는 라는 이름의 5개의 다른 폴더가 있습니다 **애플리케이션**, **채널**, **장치**, **위치**, 및 **일정**.
...
1. 프로젝트를 만든 후 **데모 화면** 프로젝트 및 클릭 **채널** 아래 그림과 같은 폴더입니다. 클릭 **+ 만들기** 작업 표시줄에서
...
1. 다음 위치로 이동 **DemoProject** 을(를) 만들고 을(를) 클릭합니다. **테스트 채널** 다음에서 **채널** 폴더를 삭제합니다.
...
1. 다음 위치로 이동 **DemoProject** 을(를) 만들고 을(를) 클릭합니다. **위치** 폴더를 삭제합니다.
1. 클릭 **+ 만들기** 작업 표시줄에서
1. 클릭 **위치** 마법사에서 를 클릭하고 **다음**.
...
1. 다음 위치로 이동 **테스트 위치** 을(를) 클릭합니다.
1. 클릭 **만들기** 작업 표시줄에서

   ![이미지](assets/kickstart/demo-disp1.png)

1. 클릭 **표시** 다음에서 **만들기** 마법사 및 클릭 **다음**.
...
1. 다음을 클릭합니다. **장치 관리자** 작업 표시줄에서

   ![이미지](assets/kickstart/demo-register1.png)

1. 다음을 클릭합니다. **장치 등록** 오른쪽 상단에서

1. 필요한 장치를 클릭하고 **장치 등록**.
...
1. 다음과 같은 경우 **등록 코드** 두 컴퓨터에서 동일함, 클릭 **유효성 검사** AEM.
...
1. 다음으로 표시 경로 클릭: **데모 화면** > **위치** > **테스트 위치** > **로비 디스플레이** 및 클릭 **할당**.
...
1. 클릭 **완료** 등록 프로세스를 완료합니다. 이제 디스플레이 대시보드에서 등록된 장치를 볼 수 있습니다.
