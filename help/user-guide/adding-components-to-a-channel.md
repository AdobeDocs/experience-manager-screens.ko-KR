...
1. 채널을 클릭합니다. 예를 들어, **`We.Retail In Store`** > **채널** > **유휴 채널**.
...
1. 구성 요소를 추가할 채널을 클릭합니다. 예를 들어, **`We.Retail In Store`** > **채널** > **유휴 채널**.

1. 클릭 **편집** 작업 표시줄에서
1. 클릭 **디자인** 모드.
1. 오른쪽의 전체 디자인 편집기를 클릭하고 설정 기호를 클릭하여 **Parsys 디자인** 대화 상자.
1. AEM Screens 프로젝트로 가져올 구성 요소를 클릭할 수 있습니다. 다음 예는 의 추가를 보여줍니다. **Livefyre** 구성 요소를 AEM Screens 프로젝트에 추가합니다.
...
전환 아이콘을 클릭하고 **구성** (렌치 아이콘) **전환** 대화 상자. 이 대화 상자에는 세 개의 탭이 있습니다.
