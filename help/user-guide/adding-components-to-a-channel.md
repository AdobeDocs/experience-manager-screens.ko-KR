...
1. AEM Screens 프로젝트로 가져올 구성 요소를 클릭할 수 있습니다. 다음 예제는 을 추가하는 방법을 보여줍니다. **Livefyre** 구성 요소를 AEM Screens 프로젝트에 추가합니다.
...
>[!NOTE]
>
>포함된 시퀀스에 대한 자세한 내용은 [포함된 시퀀스](embedded-sequences.md) 제작 화면 섹션에서 확인할 수 있습니다.
