...
| **속성** | **설명** |
|---|---|
| ***애플리케이션 경로*** | 응용 프로그램이 있는 절대 경로를 선택합니다. |
| ***지속 시간(ms)*** | 응용 프로그램 기간을 선택합니다. 기본적으로 duration은 -1로 설정되어 있으며, 이는 요소가 영원히(즉, 단일 페이지 애플리케이션) 실행됨을 의미합니다. 지속 시간 값을 0보다 높게 설정하면 지정된 지속 시간에 대한 요소가 표시된 후 다음 값으로 이동합니다. |
...
| **경험 조각** |
| ***경험 조각*** | 경험 조각을 선택합니다. |
| ***지속 시간*** | 채널에서 재생되는 경험 조각의 전체 지속 시간을 선택합니다. |
| **오프라인 구성** |
...
| **시퀀스** |
| ***지속 시간*** | 기본적으로 기간은 로 설정됩니다. *8000밀리초*. 이미지의 재생 기간을 변경하려면 **기간** 필드. |
...
<table>
 <tbody>
  ...
  <tr>
   <td><strong><em>지속 시간</em></strong></td>
...
<table>
 <tbody>
  ...
  <tr>
   <td><em><strong>지속 시간</strong></em></td>
