...
description: 이 페이지에서는 채널의 라이브 카피를 만들고 관리하는 방법에 대해 설명합니다.
...
1. 클릭 **만들기** 및 선택 **Live Copy** 을 클릭하여 채널의 라이브 카피를 만듭니다.

1. 대상을 선택하고 **다음**.
1. 라이브 카피를 저장할 위치를 선택합니다.
...
라이브 카피는 이미 존재하는 채널의 사본입니다.

라이브 카피의 콘텐츠를 보려면 아래 단계를 참조하십시오.

1. Screens 프로젝트로 이동하고 위의 섹션에 표시된 대로 Live Copy를 원래 만든 위치를 클릭합니다. (여기서 위치는 다음으로 선택됨) **채널** folder)

   ![chlimage_1-18](assets/chlimage_1-18.png)

1. 클릭 **편집** 을 클릭하여 채널에서 콘텐츠를 볼 수 있습니다.

   ![chlimage_1-19](assets/chlimage_1-19.png)

   >[!NOTE]
   >
   >라이브 카피 채널의 콘텐츠를 볼 때 메뉴에 추가 항목이 다음과 같이 표시됩니다. **Live Copy 상태**. 자세한 내용은 아래 섹션을 참조하십시오.
...
1. 다음 항목 선택 **Live Copy** 을 탭하여 채널의 세부 정보를 볼 수 있습니다.

   ![chlimage_1-21](assets/chlimage_1-21.png)

### Live Copy 상태 {#live-copy-status}

모드 **Live Copy 상태**&#x200B;아래 그림에서 보듯이 채널에 있는 모든 에셋의 관계 상태를 볼 수 있습니다.

1. 클릭 **편집** 선택: **Live Copy 상태** 라이브 카피가 생성되는 원본 채널에 대한 채널 콘텐츠의 연결을 볼 수 있습니다.

   ![chlimage_1-22](assets/chlimage_1-22.png)

1. 선택 **Live Copy 상태** 미리보기 페이지를 표시합니다.
...
라이브 카피에서 상속을 취소할 수도 있으므로 컨텐츠는 원래 분기와 독립적입니다.
...
1. 원본 채널 선택(***유휴 채널***) 및 클릭 **편집** 작업 표시줄에서
...
1. 채널의 라이브 카피(***IdleLiveCopy***) 및 클릭 **편집** 작업 표시줄에서 삭제한 이미지가 여전히 Live Copy에 표시됩니다.
...
1. 다음 항목 선택 **Live Copy** tab 키를 누른 다음 클릭 **동기화** 작업 표시줄에서

   ![chlimage_1-29](assets/chlimage_1-29.png)

1. 클릭 **동기화** 을 클릭하여 변경 내용을 확인합니다. 클릭 **저장 및 닫기** 을 클릭하여 AEM 대시보드로 돌아갑니다.
