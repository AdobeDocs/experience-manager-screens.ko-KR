...
1. 채널 지정 대화 상자에서 시작 날짜/시간 및 종료/ **날짜** 시간을 입력한 후 표현식 또는 자연어 텍스트 버전을 사용하여 되풀이 일정을 지정할 수 있습니다.
   ...
   >[!NOTE]필요에 따라 활성 시작 및 **활성** 시작 **후** 필드를 건너뛰거나 포함하고 일정 필드에 표현식을 추가할 수 있습니다.
...
>[!NOTE]또한 _오전/오후_ 표기법(즉, 오후 *2:00) 대신* 군 시간표기법(즉, 14:00)을 사용할 수도 있습니다.
...
>[!NOTE]주 및 월의 요일을 정의할 때 월/월요일, 1월/1월 등과 같은 간단한 수동 및 전체 이름 표기법을 사용할 수 있습니다.
