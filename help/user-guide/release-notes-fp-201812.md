...
AEM Screens에서 AEM 6.3 기능 팩 5 및 AEM 6.4 기능 팩 3에 대한 자세한 내용을 발표했습니다.
...
* **채널의 자산에 대한 텍스트 오버레이**:
   ...
   텍스트 오버레이는 AEM Screens에서 사용할 수 있는 기능으로, 이미지 위에 제목이나 설명을 제공하여 시퀀스 채널에서 매력적인 경험을 만들 수 있습니다. 자세한 내용은 [**텍스트**](text-overlay.md) 오버레이를 참조하십시오.

* **다중 자산 예약**:

   다중 자산 예약을 사용하면 여러 자산을 선택하고 선택한 모든 자산에 재생 일정을 적용할 수 있습니다. 자세한 내용은 **자산 예약의**&#x200B;다중 자산 예약&#x200B;**섹션을[](asset-level-scheduling.md)** 참조하십시오.

* **다중 영역 레이아웃**:

   다중 영역 레이아웃을 사용하면 여러 영역 컨텐츠를 만들고 단일 화면에서 결합할 수 있는 비디오, 이미지 및 텍스트와 같은 다양한 에셋을 사용할 수 있습니다. 자세한 내용은 **[다중 영역](multi-zone-layout-aem-screens.md)** 레이아웃을 참조하십시오.
...
다음 AEM Screens 플레이어는 AEM 6.3 기능 팩 5 및 AEM 6.4 기능 팩 3용으로 릴리스되었습니다.
