...
1. 다음 항목 선택 **작성자의 에이전트** 다음에서 **복제** 폴더 및 선택 **신규** 새 표준 복제 에이전트를 만듭니다.

   ![screen_shot_2019-02-25at25400pm](assets/screen_shot_2019-02-25at25400pm.png)

1. 다음을 입력합니다. **제목** 및 **이름** 복제 에이전트를 생성한 다음 **만들기**.

   ![screen_shot_2019-02-25at25737pm](assets/screen_shot_2019-02-25at25737pm.png)

1. 복제 에이전트를 마우스 오른쪽 단추로 클릭하고 를 선택합니다. **열기** 설정을 편집합니다.
...
1. 다음에서 **에이전트 설정** 대화 상자에서 세부 정보를 입력합니다.
   ...
   >[!NOTE]
   >
   >사용자가 확인해야 함 **활성화됨** 복제 에이전트를 사용하도록 설정합니다. 기본, 화면 및 역방향 복제 에이전트에서 이 옵션을 선택합니다.
...
에서 다음 구성이 표시되지 않는 경우 */system/console/mq*&#x200B;를 클릭한 다음 로 이동합니다. */system/console/mq* 및 선택 **다시 시작** 브로커를 다시 시작합니다.
...
1. 선택 **장치 등록**.
1. 선택 **장치 등록**.
1. 등록할 디바이스를 선택한 다음 를 선택합니다 **장치 등록**.
1. 등록 코드를 확인한 다음 **유효성 검사**.
1. 장치의 제목을 입력한 다음 을 선택합니다. **등록**.

#### 3단계: 표시할 장치 할당 {#step-assigning-the-device-to-display}

1. 선택 **디스플레이 할당** 이전 단계의 대화 상자에서 가져올 수 있습니다.
1. 에서 채널의 표시 경로 선택 **위치** 폴더를 삭제합니다.
1. 선택 **할당**.
1. 선택 **완료** 프로세스를 완료하면 장치가 할당됩니다.
...
1. 장치 선택 및 선택 **활성화** 아래 그림과 같이 작업 표시줄에서 을 선택합니다.

![screen_shot_2019-02-21at111036am](assets/screen_shot_2019-02-21at111036am.png)

>[!NOTE]
>
>또는 장치를 활성화한 후 서버 URL을 편집하거나 업데이트할 수도 있습니다. 선택 **서버 URL 편집** 아래 그림과 같이 작업 모음에서 변경 사항이 AEM Screens 플레이어에 전파됩니다.
...
1. **URL 편집** 작성자 인스턴스 URL에서 게시 인스턴스 URL 중 하나로 변경되었습니다.
...
1. 선택 **장치 관리자** 작업 표시줄에서
1. 장치 선택 및 선택 **서버 URL 편집** 아래 그림과 같이 작업 표시줄에서 을 선택하면 변경 사항이 AEM Screens 플레이어에 전파됩니다.
