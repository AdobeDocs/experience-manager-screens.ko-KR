...
1. **경험 조각의 라이브 카피 만들기**
   ...
   1. AEM 홈 페이지로 이동합니다.
   1. 선택 **경험 조각** 및 강조 표시 **ScreensFragment** 및 선택 **변형을 Live Copy로**&#x200B;아래 그림과 같이

   ![screen_shot_2019-07-29at110443am](assets/screen_shot_2019-07-29at110443am.png)

   c. **ScreensFragment** 출처: **Live Copy 만들기** 마법사 및 선택 **다음**.
   ...
   **화면 조각의 속성 편집**
   ...
   1. 다음 위치로 이동 **ScreensFragment** (이전 단계에서 생성한 경우) 을 선택하고 **속성** 작업 표시줄에서
...
1. **화면 채널에서 경험 조각을 구성 요소로 사용**
   ...
   1. 다음 항목 선택 **테스트 채널** 및 선택 **편집** 작업 표시줄에서

   1. 측면 탭에서 구성 요소 아이콘을 선택합니다.
...
1. 에서 경험 조각 선택 **사이트** (기본) 페이지에서 연필 아이콘을 선택하여 경험 조각의 항목을 편집할 수 있습니다.

   ![screen_shot_2018-06-08at122655pm](assets/screen_shot_2018-06-08at122655pm.png)

1. 경험 조각 을 선택하고 렌치 아이콘을 선택하여 대화 상자를 열어 이미지를 편집할 수 있습니다.
...
1. 채널에서 사용되는 조각에 변경 사항을 전파할 수 있도록 경험 조각 을 선택하고 롤아웃 아이콘을 선택합니다.
