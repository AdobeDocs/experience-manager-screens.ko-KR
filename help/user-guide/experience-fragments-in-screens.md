...
>[!NOTE]
>다음 예에서는 **We.Retail**&#x200B;을 데모 프로젝트로 사용합니다. 여기서 경험 조각은 **Sites** 페이지에서 AEM Screens 프로젝트로 활용됩니다.
...
아래 절차에 따라 **We.Retail**&#x200B;에서 **DemoProject**&#x200B;의 **TestChannel**&#x200B;까지의 콘텐트를 활용하십시오.

1. **We.Retail에서 사이트 페이지로 이동**

   1. 사이트로 이동하고 **We.Retail In-Store** -> **채널** ->**유휴 채널 - Night**&#x200B;을 선택하고 이 페이지를 선택하여 이 페이지를 스크린 채널의 경험 조각으로 사용합니다.
...
1. **경험 조각 만들기**
   ...
   1. **작업**&#x200B;을 **새 경험 조각 만들기**&#x200B;를 선택합니다.

   1. **상위 경로**&#x200B;를 선택합니다.
   1. **템플릿**&#x200B;을 선택합니다. 여기에서 **경험 조각 - 스크린 변형** 템플릿을 선택합니다.

   1. **조각 제목**&#x200B;을 **ScreensFragment**&#x200B;으로 입력합니다.
...
1. **경험 조각 Live Copy 생성**
   ...
   1. AEM 홈 페이지로 이동합니다.
   1. **경험 조각**&#x200B;을 선택하고 **ScreensFragment**&#x200B;을 강조 표시한 다음 아래 그림과 같이 **Variation as live-copy**&#x200B;를 클릭합니다.
   ...
   **화면 조각의 속성 편집**
   ...
   1. **ScreensFragment**(이전 단계에서 생성됨)으로 이동하고 작업 표시줄에서 **Properties**&#x200B;을 클릭합니다.

   1. 아래 그림과 같이 **오프라인 구성** 탭을 선택합니다.

   경험 조각에 **클라이언트측 라이브러리**(java 및 css) 및 **정적 파일**&#x200B;을 추가할 수 있습니다.
...
1. **스크린 채널에서 경험 조각을 구성 요소로 사용**
   ...
   e.**경험 조각** 구성 요소를 선택하고 맨 위 왼쪽(공경) 아이콘을 선택하여 **경험 조각** 대화 상자를 엽니다.

   f.**경로**&#x200B;의 *단계 3*&#x200B;에서 작성한 조각의 **스크린** 라이브 복사본을 선택합니다.

   ![screen_shot_2019-07-26at82650pm](assets/screen_shot_2019-07-26at82650pm.png)

   f.**경험 조각**&#x200B;의 *단계 3*&#x200B;에서 작성한 조각의 **Screens** 라이브 복사본을 선택합니다.

   ![screen_shot_2019-07-26at82509pm](assets/screen_shot_2019-07-26at82509pm.png)

   h.**지속 시간**&#x200B;에 밀리초 값을 입력합니다.

   i.클라이언트 측 라이브러리 및 정적 파일을 정의하려면 **경험 조각** 대화 상자에서 **오프라인 구성**&#x200B;을 선택합니다.
...
이전 단계를 완료한 후 다음 방법을 통해 **ChannelOne**&#x200B;에서 경험 조각의 유효성을 확인할 수 있습니다.
...
## 페이지 {#propagating-changes-from-the-master-page}에 변경 내용 전파

***Live*** Copy는 롤아웃 구성에 정의된 대로 동기화 작업으로 유지 관리되는 소스의 사본을 참조합니다.

경험 조각 이후, 생성된 내용은 **사이트** 페이지의 Live Copy이므로, 마스터 페이지에서 특정 조각을 변경하는 경우, 채널 또는 경험 조각을 사용한 대상의 변경 사항을 볼 수 있습니다.
...
### {#validating-the-changes} 변경 내용 유효성 확인
