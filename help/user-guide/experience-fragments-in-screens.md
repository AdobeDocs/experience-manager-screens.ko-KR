...
description: 이 페이지를 따라 AEM Screens에서 경험 조각 사용에 대해 알아보십시오.
...
1. 클릭 **만들기** 을 클릭하여 마법사를 엽니다.
1. 다음을 선택합니다. **시퀀스 채널** 마법사에서 템플릿을 클릭하고 **다음**.
...
1. **We.Retail에서 사이트 페이지로 이동**
   ...
   1. 클릭 **편집** 작업 표시줄에서 Screens 채널에 대한 경험 조각으로 사용할 페이지를 엽니다.

1. **콘텐츠 재사용**

   1. 채널에 포함할 조각을 선택합니다.
   1. 오른쪽에서 마지막 아이콘을 클릭하여 **경험 조각으로 변환** 대화 상자.
...
1. **경험 조각의 라이브 카피 만들기**
   ...
   **화면 조각의 속성 편집**
   ...
   다음 예는 경험 조각에 정적 파일의 일부로서 클라이언트측 라이브러리와 글꼴을 추가하는 방법을 보여줍니다.  ![조각](assets/fragment.gif)
...
1. 경험 조각 을 선택하고 렌치 아이콘 을 클릭하여 이미지를 편집할 수 있는 대화 상자를 엽니다.
...
1. 클릭 **미리 보기** 작업 표시줄에서 을 클릭하여 변경 내용을 확인합니다.
