...
| **표현식** | **해석** |
|---|---|
| 월,수,금 | 자산이 매주 월요일, 수요일, 금요일부터 채널에서 재생됩니다 |
| 월목 | 자산이 월요일부터 목요일까지 채널에서 재생됩니다. |

>[!NOTE]
>또한 _간단한_ 표기법(즉, 월요일, 수요일, 금요일) _대신 전체_ 표기법을 사용할 수도 있습니다(즉, 월, 수, 금).
...
| **표현식** | **해석** |
|---|---|
| 2월 5월 8월 11일 | 자산은 2월, 5월, 8월, 11월에 채널에서 재생됩니다 |
...
| **표현식** | **해석** |
|---|---|
| 월 6시 이후 18시 전, 월 1월 3일 수 | 자산 기능은 1월부터 3월 말까지 매주 월요일과 수요일 오전 6시부터 오후 6시까지 작동합니다 |
...
> [!NOTE]
> 주 및 월의 요일을 정의할 때 월/월요일, 1월/1월 등과 같은 간단한 수동 및 전체 이름 표기법을 사용할 수 있습니다.  또한 _오전/오후_ 표기법(즉, 오후 *2:00) 대신* 군 시간표기법(즉, 14:00)을 사용할 수도 있습니다.
