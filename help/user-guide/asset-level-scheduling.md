...
***자산 수준 활성화*** 플레이어의 로컬 시간대 내에서 예약된 시간대 동안 채널의 특정 에셋을 활성화할 수 있습니다. 이 기능은 이미지, 비디오, 전환, 페이지 및 포함된 채널(동적 또는 정적)에 사용할 수 있습니다.
...
1. 아무 채널이나 클릭한 다음 **편집** 작업 표시줄에서
   ...
   >방법 자세히 알아보기
   >
   >* 프로젝트를 만듭니다. 다음을 참조하십시오 [새 프로젝트 만들기](creating-a-screens-project.md).
...
***범용 시작 시간에 대한 전역 재정의*** 다음을 구성하여 작업을 수행합니다. **활성화** 탭으로 이동하여 에셋의 속성에 액세스합니다. 자산 예약에 대한 전역 재정의를 수행하려면 아래 단계를 따르십시오.
