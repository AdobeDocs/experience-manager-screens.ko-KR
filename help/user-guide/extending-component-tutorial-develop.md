...
1. [AEM 6.4](https://docs.adobe.com/content/help/en/experience-manager-64/release-notes/release-notes.html) 또는 [AEM 6.3](https://helpx.adobe.com/experience-manager/6-3/release-notes.html) + 최신 스크린 기능 팩
1. [AEM 스크린 플레이어](/help/user-guide/aem-screens-introduction.md)
1. 로컬 개발 환경

자습서 단계 및 스크린샷은 CRXDE-Lite를 사용하여 수행됩니다. [Eclipse](https://docs.adobe.com/content/help/en/experience-manager-64/developing/devtools/aem-eclipse.html) 또는 [IntelliJ](https://docs.adobe.com/content/help/en/experience-manager-64/developing/devtools/ht-intellij.html) IDE를 사용하여 자습서를 완료할 수도 있습니다. IDE를 사용하여 AEM을 [개발하는 방법에 대한 자세한 내용은 여기를](https://docs.adobe.com/content/help/en/experience-manager-learn/getting-started-wknd-tutorial-develop/project-setup.html#eclipse-ide)참조하십시오.

## 프로젝트 설정 {#project-setup}

스크린 프로젝트의 소스 코드는 일반적으로 다중 모듈 Maven 프로젝트로 관리됩니다. 튜토리얼을 신속하게 진행하기 위해 AEM Project Tranype 13을 사용하여 프로젝트를 미리 [생성했습니다](https://github.com/adobe/aem-project-archetype). Maven AEM Project Tranype을 사용하여 프로젝트를 [만드는 방법에 대한 자세한 내용은 여기를](https://docs.adobe.com/content/help/en/experience-manager-learn/getting-started-wknd-tutorial-develop/project-setup.html#maven-multimodule)참조하십시오.
