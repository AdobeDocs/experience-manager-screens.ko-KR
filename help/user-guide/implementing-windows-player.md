...
Ad-Hoc 메서드를 사용하면 최신 Windows Player(*.exe*). 다음 방문: [**AEM 6.5 플레이어 다운로드**](https://download.macromedia.com/screens/) 페이지를 가리키도록 업데이트하는 중입니다.
...
| cloudMode | Windows Player를 Screens에 as a Cloud Service으로 연결하려면 true로 설정합니다. AMS 또는 온프레미스 AEM에 연결하려면 false로 설정합니다. |
...
1. 에서 해당 키오스크 사용자의 Windows Player를 설치합니다. [AEM Screens 플레이어 다운로드](https://download.macromedia.com/screens/) 페이지를 가리키도록 업데이트하는 중입니다.
