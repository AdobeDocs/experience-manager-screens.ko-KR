...
1. **해당 위치의 채널에 콘텐츠를 추가합니다.**
   ...
   다음 위치로 이동 **데모** > **위치** > **지역 A** > **지역 A** 및 선택 **편집** 작업 표시줄에서 채널에 추가하려는 자산을 드래그 앤 드롭합니다.
   ...
   마찬가지로 다음 위치로 이동합니다. **데모** > **위치** > **지역** > **지역** 및 선택 **편집** 아래 표시된 대로 작업 표시줄에서 자산을 채널로 드래그하여 놓습니다.
...
1. **일정 만들기**
   ...
   탐색 및 선택 **일정** AEM Screens 폴더를 추가합니다. 그런 다음 을 선택합니다 **만들기** 작업 표시줄에서
...
1. **예약에 채널 할당**
   ...
   1. 다음으로 이동 **데모** > **일정** > **AdSchedule** 및 선택 **대시보드** 작업 표시줄에서
   1. 선택 **+ 채널 할당** 출처: **할당된 채널** 패널 을 클릭하여 **채널 할당** 대화 상자.
   1. 선택 **참조 채널** 경로 기준.
...
1. **각 디스플레이에 일정 할당**
   ...
   1. 선택 **대시보드** 작업 표시줄에서
   1. 대시보드에서 을(를) 선택합니다 **...** 다음에서 **할당된 채널 및 일정** 패널, 선택 **+일정 할당**.
...
1. **그룹 만들기**
   ...
   1. 선택 **도구** > **보안** > **그룹**.
   1. 선택 **그룹 만들기** 및 입력 **Global-Author** 위치: **ID**.
   1. **저장 후 닫기**&#x200B;를 선택합니다.
...
1. **사용자 만들기 및 그룹에 사용자 추가**
   ...
   1. 다음으로 이동 **Adobe Experience Manager**.
   1. 선택 **도구** > **보안** > **사용자**.
   1. 선택 **사용자 만들기** 및 입력 **전역 사용자** 위치: **ID**.
   1. 입력 **암호** 및 이 사용자의 암호를 확인합니다.
   1. 다음 항목 선택 **그룹** 을(를) 탭하고 의 그룹 이름을 입력합니다. **그룹 선택**&#x200B;예를 들어 다음을 입력합니다. **Global-Author** 추가하려면 **전역 사용자** 특정 그룹에 연결합니다.
   1. **저장 후 닫기**&#x200B;를 선택합니다.
...
1. **각 그룹에 대한 권한 액세스**
   ...
   1. 검색 대상 **Global-Author** 및 선택 **권한** 아래 그림과 같이 탭으로 이동합니다.
