...
AEM 사용 또는 기술 오류에 대한 질문을 보고할 수 있습니다. 를 통해 일반 지원 프로세스 사용 [Experience Cloud 엔터프라이즈 지원 포털](https://experienceleague.adobe.com/ko?support-solution=General#support) 또는에서 논의됨 [Experience Manager 커뮤니티](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/ct-p/adobe-experience-manager-community?profile.language=ko).
